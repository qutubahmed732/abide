...
import CoursesImage1 from "../../images/courses-hero-image-1.png";
import CoursesImage2 from "../../images/courses-hero-image-2.png";

import cardImage1 from "../../images/courses-card-1.png"
import cardImage2 from "../../images/courses-card-2.png"
import cardImage3 from "../../images/courses-card-3.png"
...
export default function CoursesPage() {
  ...
  const cards = [
    { id: 1, label: "Men", img: cardImage1 },
    { id: 2, label: "Women", img: cardImage2 },
    { id: 3, label: "Couple", img: cardImage3 },
  ]

  return (
    <>
      <div className="w-full bg-black flex items-start justify-center pb-10">
        <h1 className="text-2xl md:text-[50px] text-white font-bold">Learn Abiding Online</h1>
      </div>
      ...
      <section className="px-5 py-10 md:py-20 w-full">
        ...
        <Cards cards={cards} label={setLabel} open={open} opener={setOpen} />
      </section>
      <CourseModal label={label} open={open} opener={setOpen} />
    </>
  )
}